...
@section('content')
  ...
  <form action="{{route('show-reservation-slot-with-date', [$group])}}" method="post">
	...
	<a href="{{route('check-time-for-reservation-slot-group', ['group' => $group, 'desired_date' => date('m-d-Y', $today)])}}" class="btn btn-success" style="margin-right: 9px;">Reserve slots for this date</a>
