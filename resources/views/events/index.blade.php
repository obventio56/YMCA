	...
	<table class="table table-bordered table-striped">
	  ...
	  <tbody>
        ...
        <td>
         	 	...
         	 	<a href="{{route('destroy-event', $event)}}" confirm="Are you sure?" class="btn btn-danger pull-right">Delete Event</a><br/><br/>
          	<a href="{{route('edit-event', $event)}}"  style="margin-right: 9px;" class="btn btn-info pull-right">Edit Event</a><br/>
        	@endif
				</td>
	    </tr>
	    @endforeach
